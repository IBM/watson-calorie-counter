...
repository](https://github.com/IBM/watson-calorie-counter).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/watson-calorie-counter/issues). Before embarking on
...
issue](https://github.com/IBM/watson-calorie-counter/issues) before sending a pull
...
Please feel free to connect with us: [here](https://github.com/IBM/watson-calorie-counter/issues)
